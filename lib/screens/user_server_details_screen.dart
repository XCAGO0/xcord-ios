...
class UserServerDetailsScreen extends StatefulWidget {
  final String serverId;
  final String token;
  final Map<String, dynamic> basicInfo;

  const UserServerDetailsScreen({
    super.key,
  ...
  @override
  State<UserServerDetailsScreen> createState() => _UserServerDetailsScreenState();
}

class _UserServerDetailsScreenState extends State<UserServerDetailsScreen> {
              ...
              children: [
                if (widget.basicInfo['icon'] != null)
                  ...
                  CircleAvatar(
                    radius: 40,
                    backgroundColor: AppColors.cardBackground,
                    child: Icon(Icons.discord, color: AppColors.textPrimary, size: 40),
                  ),
